...
import static br.com.sw2you.realmeet.validator.ValidatorConstants.ROOM_SEATS_MAX_LENGTH;
...
public class RoomValidator {
    ...
    public void validate(CreateRoomDTO createRoomDTO){
        ...
        validateMaxLength(createRoomDTO.getName(), ROOM_NAME, ROOM_SEATS_MAX_LENGTH, validationErrors);
